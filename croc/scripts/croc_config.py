"""CROC Strategy — Shared config, MCP helpers, state I/O."""
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "croc-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "croc-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("CROC_WALLET", "")
    strategy_id = os.environ.get("CROC_STRATEGY_ID", "")
