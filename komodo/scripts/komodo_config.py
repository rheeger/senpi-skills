"""KOMODO Strategy — Shared config, MCP helpers, state I/O."""
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "komodo-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "komodo-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("KOMODO_WALLET", "")
    strategy_id = os.environ.get("KOMODO_STRATEGY_ID", "")
