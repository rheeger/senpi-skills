...
from fox_config import get_all_active_positions, WORKSPACE, atomic_write, mcporter_call
...
def main():
    try:
        ...
        strategy_slots = {}
        try:
            from fox_config import load_all_strategies, dsl_state_glob
        ...
        # --- Output ---
        verbose = os.environ.get("FOX_SCANNER_VERBOSE") == "1"
