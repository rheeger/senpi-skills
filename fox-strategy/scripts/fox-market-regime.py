...
from fox_config import mcporter_call_safe

def get_candles(asset, dex=None):
    """Fetch 1h, 4h, 1d candles for an asset via centralized MCP helper."""
    kwargs = {
        "asset": asset,
    ...
    data = mcporter_call_safe("market_get_asset_data", timeout=30, **kwargs)
    if data:
