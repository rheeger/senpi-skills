"""
barracuda_lib.py — Pure Python technical analysis library for BARRACUDA.
...
def aggression_mode(daily_rate_needed: float) -> str:
    ...
    v3 thresholds — realistic targets learned from 10 days live trading.
    Old: CONSERVATIVE<8, NORMAL<15, ELEVATED<25, ABORT>25
    New: CONSERVATIVE<3, NORMAL<8, ELEVATED<15, ABORT>15"""
    if daily_rate_needed is None or daily_rate_needed > 15:
        return "ABORT"
