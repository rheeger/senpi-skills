...
**Model overrides**: Each job specifies its model directly. All jobs use Sonnet-class models minimum. Change these to match your provider.
...
|------|-----|----------------|
| Tier 1 | Scanners, OI tracker, DSL math | `anthropic/claude-sonnet-4-5-20250929` |
...
- **Model per job**: All jobs use Sonnet-class models minimum. No model switching on the main session.
